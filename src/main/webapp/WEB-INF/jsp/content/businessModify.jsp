...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body style="background: #e1e9eb;">
		<form id="mainForm" method="post" action="${basePath}/businesses/${businessList[0].id}" enctype="multipart/form-data">
					...
					<table class="tab1" width="100%">
						<tbody>
							<tr>
								...
								<td width="30%">
									<input name="title" value="${businessList[0].title}" class="allInput" style="width:100%;" type="text"/>
								</td>
								<td align="right" width="15%">副标题<font color="red">*</font>：</td>
								<td width="30%">
									<input name="subtitle" value="${businessList[0].subtitle}" class="allInput" style="width:100%;" type="text"/>
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td width="30%">
									<a href="${businessList[0].imgFileName}">查看图片</a>
									<input type="hidden" name="img" value="${businessList[0].imgFileName}"/>
							...
							<tr>
								...
								<td width="30%">
									<input name="price"  value="${businessList[0].price}" class="allInput" style="width:100%;" type="text"/>
								</td>1
								<td align="right" width="10%">距离(单位：米)<font color="red">*</font>：</td>
								<td width="30%">
									<input name="distance" value="${businessList[0].distance}" class="allInput" style="width:100%;" type="text"/>
								</td>
							</tr>
							<tr>
								<td align="right">描述<font color="red">*</font>：</td>
								<td width="30%" colspan="3">
									<textarea name="desc" rows="5" style="width:100%;">${businessList[0].desc}</textarea>
								</td>
							</tr>
						</tbody>
					</table>
